 ...
 */
public class ChangelogMapState<K, N, UK, UV> implements InternalMapState<K, N, UK, UV> {
    private final InternalMapState<K, N, UK, UV> mapState;

    ChangelogMapState(InternalMapState<K, N, UK, UV> mapState) {
    ...
    public InternalMapState<K, N, UK, UV> getDelegatedMapState() {
        return mapState;
    }
