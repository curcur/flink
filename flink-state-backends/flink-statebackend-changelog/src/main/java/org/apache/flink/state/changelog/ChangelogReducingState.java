 ...
 */
public class ChangelogReducingState<K, N, V> implements InternalReducingState<K, N, V> {
    private final InternalReducingState<K, N, V> reducingState;

    ChangelogReducingState(InternalReducingState<K, N, V> internalReducingState) {
    ...
    public InternalReducingState<K, N, V> getDelegatedReducingState() {
