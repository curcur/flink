...
public class ChangelogKeyedStateBackend<K>
    ...
    private final PeriodicMaterializationManager periodicMaterializationManager;
    ...
    public ChangelogKeyedStateBackend(
        ...
        this.periodicMaterializationManager =
     ...
     */
    public Optional<Tuple2<RunnableFuture<SnapshotResult<KeyedStateHandle>>, SequenceNumber>>
            initMaterialization() throws Exception {
    ...
    public void updateChangelogSnapshotState(
        ...
        changelogSnapshotState =
                new ChangelogSnapshotState(
                        getMaterializedResult(materializedSnapshot), new ArrayList<>(), upTo);
    }
