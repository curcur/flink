...
/**
 * A {@link DelegateKeyedStateBackend} that keeps state on the underlying delegated keyed state
 * backend as well as on the state change log.
 *
 * @param <K> The key by which state is keyed.
 */
public class ChangelogKeyedStateBackend<K> implements DelegateKeyedStateBackend<K> {
    ...
    public boolean requiresLegacySynchronousTimerSnapshots(CheckpointType checkpointOptions) {
        return keyedStateBackend.requiresLegacySynchronousTimerSnapshots(checkpointOptions);
    }
