 ...
 *
 * <p>As its name, it should include a state backend to delegate. The delegated state backend itself
 * can not be a {@link DelegateStateBackend}.
 *
 * <p>TODO: provide configurable way to verify whether a state backend can be delegated.
 */
@Internal
