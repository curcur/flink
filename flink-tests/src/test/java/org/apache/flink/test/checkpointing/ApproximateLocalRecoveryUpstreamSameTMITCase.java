...
/** Use LocalInputChannel. Only for Upstream Reconnection. **/
public class ApproximateLocalRecoveryUpstreamSameTMITCase {
	...
	public void localTaskFailureRecovery() throws Exception {
		...
		int failAfterElements = numElementsPerTask / 4;
